package com.shupian.pvms.config;
...
public class CaptchaConfig
{
    ...
    public DefaultKaptcha getKaptchaBeanMath()
    {
        ...
        properties.setProperty(KAPTCHA_BORDER, "yes");
        // 边框颜色 默认为Color.BLACK
        properties.setProperty(KAPTCHA_BORDER_COLOR, "151,223,253");
        // 验证码文本字符颜色 默认为Color.BLACK
        ...
        // 验证码文本生成器
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL, "com.wzy.usercenter.config.CaptchaConfig");
        // 验证码文本字符间距 默认为2
